...
> [!IMPORTANT]
> These scripts make a backup of the _.toml_ files (as _.toml.bak_ files), but do not take in account what ports were already configured _when incrementing_. It calculates the new port value **using the default port values** stated in the script itself.
